package com.zeeshan.foodjar.utils;
...
public class RecyclerItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    private RecyclerHelperTouchItemListener listener;

    public RecyclerItemTouchHelper(int dragDirs, int swipeDirs, RecyclerHelperTouchItemListener listener) {
